...
const navigate = useNavigate();
    ...
    const submitFormData = (e) => {
        ...
        if(Object.keys(newErrors).length > 0){
            ...
            axios.put('http://localhost:8080/api/account', account,  {
                headers: {
                    Authorization: 'Bearer_' + localStorage.getItem("token"),
                    'Access-Control-Allow-Origin': "*",
                    "Access-Control-Allow-Headers": "Origin, X-Requested-With, Content-Type, Accept",
    ...
    const findFormErrors = () => {
        ...
        const { firstName, lastName, password } = account
        const newErrors = {}
        ...
        <Card className="" style={{marginTop: "3%"}}>
            <Form className="px-2 shadow-lg rounded-3"
                ...
                <Form.Group className="mt-3">
                    <textarea className="w-100" rows="3" name="description" onChange={handleChange}
